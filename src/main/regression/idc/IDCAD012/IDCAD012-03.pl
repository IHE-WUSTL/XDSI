...
die "Usage: IDCAD012-03.pl LOCAL_ID AFFINITY-DOMAIN_ID C-Move_SCP_Name [simulator-name] \n" .
...
xdsi::rad16_sequence_idc($ARGV[0], $ARGV[1], $simulator, $cmove_name, "STUDY:SERIES:INSTANCE");
