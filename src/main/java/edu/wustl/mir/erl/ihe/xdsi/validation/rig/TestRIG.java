 ...
 * 
 */
package edu.wustl.mir.erl.ihe.xdsi.validation.rig;
...
import edu.wustl.mir.erl.ihe.xdsi.validation.iig.TestIIG;

/**
 * Process test validations for RIG SUT
 * 
...
public static void runTests(String testName, String session, String rRoot, String sRoot) throws Exception {
   ...
   // Load sut-####.xml file
   URL url = TestRIG.class.getResource(testName + ".xml");
