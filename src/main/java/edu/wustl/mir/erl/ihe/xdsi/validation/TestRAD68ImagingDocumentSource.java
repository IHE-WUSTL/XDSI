...
public class TestRAD68ImagingDocumentSource extends Test {
   ...
   public void initializeTest(String[] args) throws Exception {
	...
	private void initializeMethodLogs(String[] args) throws Exception {
        ...
        ProcessNISTSimulatorLogs.main(new String[] {"GETKOS", simulator, pidAffinityDomain, "-", test.toString(), "kos.dcm"});
        ProcessNISTSimulatorLogs.main(new String[] {"GETMETADATA", simulator, pidAffinityDomain, "-", test.toString(), "metadata.xml"});
	...
	private void initializeMethodLogs2(String[] args) throws Exception {
        ...
        ProcessNISTSimulatorLogs.main(new String[] {"GETKOS",      simulator, "rep", "prb", pidAffinityDomain, "-", test.toString(), "kos.dcm"});
        ProcessNISTSimulatorLogs.main(new String[] {"GETMETADATA", simulator, "rep", "prb", pidAffinityDomain, "-", test.toString(), "metadata.xml"});
        this.fileMustExist(test, "kos.dcm");
        this.fileMustExist(test, "metadata.xml");
