...
die "Usage: ids-mammography-01.pl system-name \n" .
...
my $patient_name = "Xra^Twelve";
my $dob = "19930124";
my $sex = "M";
my $study_date = "20151224";

print "\nUse the images HERE and create a new image with new identifiers\n";
xdsi::generate_new_image_set_full("$XDSI/storage/runtime/$identifier_local/images",
	"$XDSI/storage/reference/IHE-testimages/MG/TCGA-BRCA/TCGA-AO-A0JF",
...
print "\nSend the new image set to the DICOM SCP described in $ARGV[0]\n";
