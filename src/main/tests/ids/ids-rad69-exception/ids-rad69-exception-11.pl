...
# Validation script for ids-rad69-exception test.
...
my $test_name = "ids-rad69-exception";
...
xdsi::validate_rad69_exception($pid_dept, $pid_ad, $simulator, $ids_name,  $extension, $label, $test_name);
