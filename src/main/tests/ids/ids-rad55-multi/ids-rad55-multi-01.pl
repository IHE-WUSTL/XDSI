...
die "Usage: ids-rad55-multi-01.pl system-name \n" .
...
my $patient_name = "Fiftyfive^Multi";
my $dob = "19930123";
my $sex = "M";
my $study_date = "20151223";
...
print "\nSend the new images to the DICOM SCP described in $ARGV[0]\n";
