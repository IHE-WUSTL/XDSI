...
die "Usage: ids-rad55-multi-03.pl LOCAL_ID AFFINITY-DOMAIN_ID WADO-URL [simulator-name] \n" .
...
xdsi::rad55_baseline($ARGV[0], $ARGV[1], $simulator, $wado_url, "STUDY:SERIES:INSTANCE");
